...
%>
<%
javax.servlet.http.HttpSession createSession = request.getSession(false);
if (createSession == null || createSession.getAttribute("emailValue") == null) {
    response.sendRedirect(request.getContextPath() + "/login");
    return;
}

String email = (String) createSession.getAttribute("emailValue");
